...
namespace SWE_Project
{
    internal class Customer : Actor
    {
        ...
        // public void ScheduleFlight(bool writeIn, System.DateTime dateIn="12/24/2022", string departureIn="", string arrivalIn="", bool roundtrip=false)
                            ...
                            do
                            {
                                ...
                                else
                                {
                                    ...
                                    if (connecting != "")
                                    {
                                        ...
                                        ScheduleFlight(true, (System.DateTime.Parse(planeChoice[4])).Date, planeChoice[3], connecting, false);
                                        if (roundtrip)
                                        {
                                            ...
                                            ScheduleFlight(true, (System.DateTime.Parse(planeChoice[4])).Date.AddDays(double.Parse(Console.ReadLine())), connecting, planeChoice[3], false);
                                        }
                                    }
                                    else
                                    {
                                        if (roundtrip)
                                        {
                                            Console.WriteLine("Now lets book your return trip");
                                            Console.WriteLine("How many days do you plan on staying in your destination?");
                                            ScheduleFlight(true, (System.DateTime.Parse(planeChoice[4])).Date.AddDays(double.Parse(Console.ReadLine())), planeChoice[3], planeChoice[1], false);
                                        }
                                    }
                                    return;
                                }
        ...
        public void ScheduleFlight(bool writeIn, System.DateTime dateIn, string departureIn, string arrivalIn, bool roundtrip)
        {
            // Write command line part
